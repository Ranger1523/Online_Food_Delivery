...
<body>
				...
				<div class="signup-content">
					<div class="signup-form">
						...
						<form method="post" action="register" class="register-form"
							...
							<div>User Type :</div>
							<div class="form-group">
								<label for="usertype"></label> <select name="usertype"
									id="usertype">
	...
	<script type="text/javascript">
		...
		if (status == "success") {
			...
			swal("Warning", "Please Enter the Name", "error");
			...
			swal("Warning", "Passwords do not match", "error");
		} else if (status == "invalidMobile") {
			swal("Warning", "Please Enter the Mobile Number", "error");
		} else if (status == "invalidMobileLength") {
			swal("Warning", "Entered Mobile Length is Invalid", "error");
		} else if (status == "invalidSecurityAnswer") {
			swal("Warning", "Please answer the security questions", "error");
		}
	</script>
