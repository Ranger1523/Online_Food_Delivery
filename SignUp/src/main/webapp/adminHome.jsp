    ...
    <section class="tm-welcome-section">
      <div class="container tm-position-relative">
        ...
        <div class="row tm-welcome-content">
          <h2 class="white-text tm-handwriting-font tm-welcome-header"><img src="img/header-line.png" alt="Line" class="tm-header-line">Behind The Scenes Of&nbsp;<img src="img/header-line.png" alt="Line" class="tm-header-line"></h2>
          <h2 class="gold-text tm-welcome-header-2">THE BARATIE</h2>
          ...
          <a href="viewOrders" class="tm-more-button tm-more-button-welcome">View Orders</a>      
		  <a href="viewCustomers" class="tm-more-button tm-more-button-welcome" >View Customers</a>
		  <a href="viewProducts" class="tm-more-button tm-more-button-welcome">View Products</a>
		  <a href="logout" class="tm-more-button tm-more-button-welcome">Logout</a>
        </div>
